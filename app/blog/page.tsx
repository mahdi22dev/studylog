    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col relative overflow-hidden">
      ...
      <main className="relative z-10 flex-grow pt-28 pb-24 max-w-[1200px] mx-auto px-6 w-full">
        ...
        <section className="mb-16">
          <div className="bg-muted/90 backdrop-blur-xl border border-border rounded-2xl overflow-hidden flex flex-col lg:flex-row group cursor-pointer hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-300">
            <div className="w-full lg:w-3/5 h-[280px] lg:h-[420px] relative overflow-hidden">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-popover via-transparent to-transparent opacity-80" />
            </div>
            <div className="w-full lg:w-2/5 p-8 flex flex-col justify-between">
              <div>
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/20 text-secondary text-xs font-bold uppercase tracking-wider mb-4">
                  <Brain className="h-3.5 w-3.5" />
                  Featured Research
                </span>
                <h2 className="font-heading text-2xl md:text-3xl font-bold text-white mb-4 group-hover:text-secondary transition-colors">
                  The Flow State
                </h2>
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {posts.map((post, i) => (
              <article
                key={i}
                className="bg-muted/90 backdrop-blur-xl border border-border rounded-2xl overflow-hidden flex flex-col group cursor-pointer hover:-translate-y-1.5 hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/15 transition-all duration-300"
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <h3 className="font-heading text-lg font-bold text-white mb-3 group-hover:text-secondary transition-colors leading-snug">
                    {post.title}
                  </h3>
        ...
        {/* Newsletter Box */}
        <section className="bg-gradient-to-r from-primary/10 via-muted to-success/10 border border-primary/30 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden shadow-2xl">
          <div className="relative z-10 max-w-xl mx-auto flex flex-col items-center">
            ...
            >
              <input
                ...
                className="flex-grow bg-input border border-border rounded-full px-6 py-3 text-sm text-white placeholder-muted-foreground/40 focus:outline-none focus:border-primary transition-colors h-12"
              />
              <button
                type="submit"
                className="bg-primary hover:bg-primary/90 text-white font-semibold text-sm px-8 py-3 rounded-full transition-all duration-300 h-12 whitespace-nowrap cursor-pointer shadow-md"
              >
                Subscribe
              </button>
            </form>
