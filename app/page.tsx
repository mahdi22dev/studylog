...
export default function StudyLog() {
  ...
  useEffect(() => {
    // Load total study time from localStorage on component mount
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-5xl font-bold gradient-text tracking-tight">Study Log</h1>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-white to-purple-50/50 backdrop-blur-sm">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative z-10">
              <CardTitle className="text-sm font-semibold text-study-text-secondary">Total Study Time</CardTitle>
              <div className="p-2 bg-purple-100 rounded-lg">
                <Clock className="h-4 w-4 text-purple-600" />
              </div>
            </CardHeader>
            <CardContent className="relative z-10">
              <div className="text-3xl font-bold text-study-text mb-1">{formatTime(totalStudyTime)}</div>
              <p className="text-sm text-study-text-muted font-medium">All time progress</p>
            </CardContent>
          </Card>
          ...
          <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-white to-violet-50/50 backdrop-blur-sm">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative z-10">
              <CardTitle className="text-sm font-semibold text-study-text-secondary">Sessions Today</CardTitle>
            ...
            <CardContent className="relative z-10">
              ...
              <p className="text-sm text-study-text-muted font-medium">Coming soon</p>
            </CardContent>
          </Card>
          ...
          <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-white to-indigo-50/50 backdrop-blur-sm">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative z-10">
              <CardTitle className="text-sm font-semibold text-study-text-secondary">Weekly Goal</CardTitle>
            ...
            <CardContent className="relative z-10">
              ...
              <p className="text-sm text-study-text-muted font-medium">Target</p>
            </CardContent>
          </Card>
          ...
          <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-white to-pink-50/50 backdrop-blur-sm">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative z-10">
              <CardTitle className="text-sm font-semibold text-study-text-secondary">Streak</CardTitle>
