...
export function Hero() {
  ...
  return (
    <section className="max-w-[1200px] mx-auto px-6 flex flex-col items-center text-center pt-2 pb-2 mb-2">
      {/* Free badge */}
      <div className="inline-flex items-center gap-2 bg-[#1d1f27] py-2 px-5 rounded-full mb-8 border border-white/5 shadow-md">
      ...
      <div className="relative w-64 h-64 md:w-72 md:h-72 mb-8 flex items-center justify-center animate-float">
        ...
        <div className="relative z-10 font-heading text-[80px] md:text-[92px] leading-[92px] font-extrabold tracking-[-0.04em] text-[#c9beff] drop-shadow-2xl">
          25:00
        </div>
      </div>
      ...
      {/* Subtitle */}
      <p className="text-base md:text-lg leading-relaxed text-[#c9c3d9] max-w-2xl mx-auto mb-10 font-normal">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 mb-14">
        ...
        <a
          ...
          className="glass-card text-[#e1e2ec] border border-white/10 hover:border-white/20 hover:bg-white/5 px-8 py-3.5 rounded-full text-base font-semibold tracking-wide transition-all duration-300 flex items-center gap-2"
        >
          See how it works
          <span className="text-[#c9beff]">↓</span>
        </a>
      </div>
      ...
      <div className="flex justify-center gap-12 md:gap-24 opacity-90">
        <div className="text-center">
          <div className="font-heading text-2xl md:text-3xl font-bold tracking-[-0.02em] text-[#c9beff] mb-1">
            25min
          </div>
        ...
        <div className="text-center">
          <div className="font-heading text-2xl md:text-3xl font-bold tracking-[-0.02em] text-[#38dfab] mb-1">
            5min
          </div>
          <div className="text-xs font-semibold tracking-widest text-[#c9c3d9] uppercase">
            Break Time
